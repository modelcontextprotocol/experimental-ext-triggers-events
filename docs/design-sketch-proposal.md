...
| Server-side resource exhaustion (subscription flooding) | `-32013 ResourceExhausted` limits; webhook subscriptions are TTL'd soft state that expire without refresh. *(Error Codes)* |
